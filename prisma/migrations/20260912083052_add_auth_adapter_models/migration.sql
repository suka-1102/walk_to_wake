...
CREATE TABLE `SavedLocation` (
    ...
    INDEX `SavedLocation_userId_idx`(`userId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `Challenge` (
    ...
    `deadlineMinute` INTEGER NOT NULL,
    `startDate` DATE NOT NULL,
    `endDate` DATE NOT NULL,
    `depositYen` INTEGER NOT NULL,
    `endedAt` DATETIME(3) NULL,
    `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),

    UNIQUE INDEX `Challenge_activeUserId_key`(`activeUserId`),
...
CREATE TABLE `CheckIn` (
    ...
    UNIQUE INDEX `CheckIn_challengeId_date_key`(`challengeId`, `date`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
